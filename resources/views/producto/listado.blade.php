        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <p>
                            Un pan saludable hecho con avena integral, ideal para
                            acompañar desayunos o meriendas. Rico en fibra y perfecto
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <p>
                            Delicioso pastel suave y esponjoso, bañado en una
                            mezcla de tres leches, con un toque de vainilla y
                ...
                <tr class="bg-white dark:bg-gray-800">
                    ...
                    <td class="px-6 py-4">
                        <p>
                            Un pan suave y esponjoso con relleno de chocolate
                            fundido. Perfecto para acompañar con café o como un
                            antojo dulce en cualquier momento del día.
                        </p>
                    </td>
                    <td class="px-6 py-4">
                        $25 MXN
